...
echo -e "    python safaribooks.py <BOOK_ID>"
echo ""
echo -e "  ${CYAN}Retrieve cookies automatically from your browser:${RESET}"
echo -e "    python retrieve_cookies.py"
echo ""
echo -e "  ${CYAN}Convert downloaded EPUBs with Calibre:${RESET}"
echo -e "    python calibre_convert.py Books/*/*.epub"
echo ""
echo -e "  ${YELLOW}Note:${RESET} You must be logged into learning.oreilly.com in your browser"
echo -e "  before running retrieve_cookies.py, or paste the cookie string in the TUI."
echo ""
